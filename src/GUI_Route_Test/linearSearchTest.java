...
class linearSearchTest {
    ...
    @Test
    void testRightInput() {
        assertEquals(GUI_Route.linearSearch.getIndex(list,hasData),returnedIndex);
    }

    @Test
    void testWrongInput() {
        assertNotEquals(GUI_Route.linearSearch.getIndex(list,hasNoData),returnedIndex);
    }
}